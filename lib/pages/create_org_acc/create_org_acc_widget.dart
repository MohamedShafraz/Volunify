...
import 'create_org_acc_model.dart';
export 'create_org_acc_model.dart';

class CreateOrgAccWidget extends StatefulWidget {
  const CreateOrgAccWidget({super.key});

  @override
  State<CreateOrgAccWidget> createState() => _CreateOrgAccWidgetState();
}

class _CreateOrgAccWidgetState extends State<CreateOrgAccWidget> {
  late CreateOrgAccModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateOrgAccModel());
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        'Provide an intro to your organization...',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
