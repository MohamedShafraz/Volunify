  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EventsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventsRecord> createJobEventsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createJobEventsRecord = createJobEventsRecordList.isNotEmpty
            ? createJobEventsRecordList.first
            : null;
                            ...
                            child: StreamBuilder<List<EventsRecord>>(
                              stream: queryEventsRecord(
                                singleRecord: true,
                                  ...
                                  List<EventsRecord>
                                      checkboxGroupEventsRecordList = snapshot;
                                  ...
                                  _model.checkboxGroupPreviousSnapshot =
                                      snapshot;
                                }),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                  ...
                                  onPressed: () async {
                                    await EventsRecord.collection.doc().set({
                                      ...createEventsRecordData(
                                        ...
                                        noOfVolunteers: int.tryParse(
                                            _model.noVolTextController.text),
                                        deadline: _model.datePicked3,
                                        notes: _model.nOtesTextController.text,
                                        photo: _model
                                            .changePhotoModel.uploadedFileUrl,
                                        skill: _model.skilTextController.text,
                                      ),
                                      ...mapToFirestore(
                                        {
