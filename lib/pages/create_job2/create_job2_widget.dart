...
import 'create_job2_model.dart';
export 'create_job2_model.dart';

class CreateJob2Widget extends StatefulWidget {
  const CreateJob2Widget({
    super.key,
  ...
  @override
  State<CreateJob2Widget> createState() => _CreateJob2WidgetState();
}

class _CreateJob2WidgetState extends State<CreateJob2Widget> {
  late CreateJob2Model _model;
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'No of Volunteers Needed',
                            hintStyle:
