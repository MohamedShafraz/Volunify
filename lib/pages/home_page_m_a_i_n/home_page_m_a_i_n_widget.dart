                ...
                children: [
                  ...
                  StreamBuilder<List<EventsRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<EventsRecord> rowEventsRecordList = snapshot.data!;
                      return SingleChildScrollView(
                        scrollDirection: Axis.horizontal,
                        child: Row(
                          mainAxisSize: MainAxisSize.max,
                          children: List.generate(rowEventsRecordList.length,
                              (rowIndex) {
                            final rowEventsRecord =
                                rowEventsRecordList[rowIndex];
                            return JobCard1Widget(
                              key: Key(
                                  'Key4w5_${rowIndex}_of_${rowEventsRecordList.length}'),
                            );
                          }),
                        ),
                      );
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return InkWell(
                            ...
                            child: CreatedEventWidget(
                              key: Key(
                                  'Key324_${listViewIndex}_of_${listViewEventsRecordList.length}'),
                            ),
                          );
                        },
                      );
